    ...
    <div id="chatbot-container">
        ...
        <div id="chatbot-sidebar" class="sidebar-hidden">
            ...
            <div class="menu-options" id="main-menu">
                ...
                <button class="menu-item" onclick="window.chatbotPopUp.showContent(window.chatbotData.ubicacion.title, window.chatbotData.ubicacion.answer)">
                ...
                <button class="menu-item" onclick="window.chatbotPopUp.showContent(window.chatbotData.contactos.title, window.chatbotData.contactos.answer)">
        ...
        <div id="faq-modal" class="modal-hidden">
            <div class="modal-content">
                <button id="modal-close-btn" onclick="window.chatbotPopUp.closeFAQModal()">&times;</button>
