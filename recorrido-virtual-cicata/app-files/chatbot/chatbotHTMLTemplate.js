    ...
    <div id="chatbot-container">
        ...
        <div id="chatbot-sidebar" class="sidebar-hidden">
            ...
            <div class="menu-options" id="main-menu">
                ...
                <button class="menu-item" onclick="window.chatbotModal.showContent(window.chatbotData.ubicacion.title, window.chatbotData.ubicacion.answer)">
                ...
                <button class="menu-item" onclick="window.chatbotModal.showContent(window.chatbotData.contactos.title, window.chatbotData.contactos.answer)">
